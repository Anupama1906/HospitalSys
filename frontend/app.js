...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const loadDashboard = async() => {
        ...
        if (invoices) {
            const totalRevenue = invoices.reduce((sum, inv) => sum + (parseFloat(inv.total_amount) - parseFloat(inv.due_amount || 0)), 0);
